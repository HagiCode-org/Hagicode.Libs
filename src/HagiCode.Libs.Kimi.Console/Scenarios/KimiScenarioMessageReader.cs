...
internal static class KimiScenarioMessageReader
{
    public static async Task<KimiScenarioExecutionResult> ReadExecutionResultAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new KimiScenarioExecutionResult(messages, assistantTextBuilder.ToString().Trim(), sessionId);
    }
...
internal sealed record KimiScenarioExecutionResult(
