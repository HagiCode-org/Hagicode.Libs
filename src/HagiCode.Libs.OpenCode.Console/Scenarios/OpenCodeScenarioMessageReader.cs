...
internal static class OpenCodeScenarioMessageReader
{
    public static async Task<OpenCodeScenarioExecutionResult> ReadExecutionResultAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new OpenCodeScenarioExecutionResult(messages, assistantTextBuilder.ToString().Trim(), sessionId);
    }
...
internal sealed record OpenCodeScenarioExecutionResult(
