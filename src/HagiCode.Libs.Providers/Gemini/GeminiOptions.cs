...
/// <summary>
/// Describes a Gemini ACP CLI invocation.
/// </summary>
public sealed record GeminiOptions
{
    /// <summary>
    /// Gets or sets the custom Gemini executable path.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the optional Gemini model override.
    ...
    /// <summary>
    /// Gets or sets environment variables injected into the Gemini process.
    /// </summary>
    public IReadOnlyDictionary<string, string?> EnvironmentVariables { get; init; } = new Dictionary<string, string?>();

    /// <summary>
    /// Gets or sets the preferred Gemini authentication method identifier.
