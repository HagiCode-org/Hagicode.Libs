...
internal static class ThreadEventParser
{
    public static ThreadEvent Parse(string line)
    {
        ...
        return type switch
        {
            ...
            CodexProtocolConstants.EventTypes.TurnCompleted => new TurnCompletedEvent(
                ParseUsage(GetRequiredProperty(root, CodexProtocolConstants.Properties.Usage)),
                GetOptionalString(root, CodexProtocolConstants.Properties.Result)),
    ...
    private static ThreadItem ParseItem(JsonElement itemElement)
    {
        ...
        return itemType switch
        {
            ...
            _ => new UnknownThreadItem(
                GetOptionalString(itemElement, CodexProtocolConstants.Properties.Id) ?? $"unknown:{itemType}",
                itemType,
                itemElement.Clone()),
        };
    }
