...
internal static class GeminiScenarioMessageReader
{
    public static async Task<GeminiScenarioExecutionResult> ReadExecutionResultAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new GeminiScenarioExecutionResult(messages, assistantTextBuilder.ToString().Trim(), sessionId);
    }
...
internal sealed record GeminiScenarioExecutionResult(
